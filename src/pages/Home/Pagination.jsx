...
export default function Pagination({ nPages, currentPage, setSearchParams }) {
  ...
  function getPaginationNumbers(numberOfPages) {
    ...
    if (numberOfPages <= 6) {
      ...
      if (currentPage == numberOfPages) numbers.push(addButton(currentPage - 2));

      if (currentPage > 2) numbers.push(addButton(currentPage - 1));

      if (currentPage != 1 && currentPage != numberOfPages) numbers.push(addButton(currentPage));

      if (currentPage < numberOfPages - 1) numbers.push(addButton(currentPage + 1));
